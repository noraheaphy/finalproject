---
title: "Portulaca MAP Reconstruction"
author: "Nora Heaphy"
date: "11/30/2020"
...
node_values = c(portulacaData$CHELSA_BIOL_12, rep(NA, n_tips-1))
...
mat_ancestral = 
  ace(portulacaData$CHELSA_BIOL_12, 
    portulacaTree, 
    type = "continuous", 
    method = "REML", 
    model = "BM"  
...
node_values = c(portulacaData[,13], mat_ancestral$ace)
...
# nodes. Since we don't have values for the internal nodes, we will pad them 
# with NA (Not Available) for now.
node_values = c(portulacaData[,13], mat_ancestral_pic$ace )
...
portulacaData <- portulacaData %>% select(CHELSA_BIOL_12)
